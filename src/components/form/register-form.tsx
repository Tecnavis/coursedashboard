    ...
    <form className="tp-login-input-form" onSubmit={handleSubmit(onSubmit)}>
      <div className="row">
        ...
        <div className="col-6">
          <div className="tp-login-input p-relative">
            <label>Email </label>
            <input type="text" placeholder="Type your email " {...register("email", { required: "Email is required" })} />
        ...
        <div className="col-6">
          <div className="tp-login-input p-relative">
            <label> Phone</label>
            <input type="text" placeholder="Type your  phone number" {...register("email", { required: "Email is required" })} />
            {errors.email?.message && <ErrMsg msg={errors.email.message} />}
          </div>
        </div>
        <div className="col-12">
          <div className="tp-login-input p-relative">
            <label>Photo</label>
            <input type="file" placeholder="Your photo" style={{height:"54px",width:"100%"}} />
          </div>
        </div>
        <div className="col-12">
          <div className="tp-login-input p-relative">
            <label>Skill/Occupation</label>
            <input type="text" placeholder="Type your skill/occupation" />
          </div>
        </div>
        <div className="col-12">
          <textarea placeholder="Type your bio"></textarea>
        </div>
        <div className="col-6">
          <div className="tp-login-input p-relative">
